...
4.  **Be Explicit and Cite Sources:** When providing guidance or correcting code, explicitly state the rule or principle you are following and reference the source document.
    ...
    *   *Example:* "This feature needs to handle user consent. According to `/05-Privacy-Specific/01-user-consnet-management.md`, consent must be opt-in and recorded with a timestamp."
